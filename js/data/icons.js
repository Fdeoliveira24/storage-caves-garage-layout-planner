...
const Icons = {
  ...
  keyboard:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M7 9h.01"/><path d="M11 9h.01"/><path d="M15 9h.01"/><path d="M19 9h.01"/><path d="M7 13h.01"/><path d="M11 13h.01"/><path d="M15 13h.01"/><path d="M19 13h.01"/><path d="M8 17h8"/></svg>',
  help: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M9.6 9a2.6 2.6 0 1 1 3.8 2.3c-.9.5-1.4 1-1.4 2.2"/><circle cx="12" cy="17" r=".7" fill="currentColor" stroke="none"/></svg>',
  close:
